...
function loadDataAnimes() {
    ...
    $.ajax(
        {
            url: "/WebServices/WSlistaAnimes.asmx/getAllAnime",
            data: actionData,
            dataType: "json",
            type: "POST",
            ...
            error: function (result) {
                if (result.responseJSON.ExceptionType == "System,Security.SecurityException") {
...
function finalizaAgregarAnimes() {
    ...
    $.ajax(
        {
            url: "/WebServices/WSlistaAnimes.asmx/agregarAnime",
            data: actionData,
            dataType: "json",
            type: "POST",
            contentType: "application/json; charset=utf-8",
    ...
    $("#dialog-confirm").dialog({
        ...
        buttons: {
            "Eliminar": function () {
                ...
                $.ajax(
                    {
                        url: "/WebServices/WSlistaAnimes.asmx/eliminarAnime",
                        data: actionData,
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
...
function finalizaEditarAnime() {
    ...
    $.ajax(
        {
            url: "/WebServices/WSlistaAnimes.asmx/editarAnime",
            data: actionData,
            dataType: "json",
            type: "POST",
            contentType: "application/json; charset=utf-8",
